...
const { gerarHtmlCompra } = require('../../src/templates/compra-template');
const { gerarHtmlDesbloqueio } = require('../../src/templates/desbloqueio-template');
...
console.log('OK - datas sem hora permanecem estáveis nos PDFs de venda, compra e desbloqueio');

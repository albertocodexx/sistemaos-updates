...
// Comprovante de Venda — uma folha A4 retrato para cada via.
// Mesma paginação da OS: duas vias completas, cada uma em papel separado.
...
function criarDataLocal(valor) {
  ...
  // `new Date('AAAA-MM-DD')` interpreta a data em UTC e, no Brasil, pode
  // imprimir o dia anterior. Datas sem hora são civis e devem permanecer no

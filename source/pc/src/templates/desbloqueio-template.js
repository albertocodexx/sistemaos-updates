...
function gerarHtmlDesbloqueio(documento, config = {}) {
  ...
  return `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"/><title>${escapar(documento.numero)} - Autorização de desbloqueio</title><style>
    *,*::before,*::after{box-sizing:border-box}body{margin:0;background:#fff;color:#111;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.42}
    ...
    .assinatura{margin-top:18px;display:flex;justify-content:center;page-break-inside:avoid}.assin-box{width:min(118mm,100%);text-align:center}.assin-esp{height:58px;position:relative;display:flex;align-items:flex-end;justify-content:center}.assin-linha{box-sizing:border-box;height:0;border:0;border-top:1px solid #111;transform:none}.assin-label{font-size:8px;font-weight:800;letter-spacing:.07em;margin-top:4px}.assin-meta{font-size:8px;color:#666;margin-top:3px}.rodape{border-top:1px solid #bbb;margin-top:13px;padding-top:6px;text-align:center;color:#666;font-size:8px}

-- Garante que fotos e assinaturas enviadas depois do documento comercial
-- façam o PC puxar novamente a Compra/Venda já criada.
...
for each row
when (new.entidade_tipo in ('compra'::public.entidade_tipo, 'venda'::public.entidade_tipo))

...
assert.match(chat, /Empresa e usuário identificados automaticamente/);
assert.doesNotMatch(chat, /for="(?:empresa|usuario|nome)-novo-chamado-app"/);
assert.match(chat, /FLUXOS_MOTIVO/);
assert.match(suporteGlobal, /resumoContextoChamado/);
